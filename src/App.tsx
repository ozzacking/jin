...
function App() {
  ...
  const renderPage = () => {
      ...
      case 'best-pillow-for-neck-pain-and-sleep': return <BestPillowForNeckPainAndSleepGuide />;
      case 'sleep-temperature-and-thermoregulation-guide': return <SleepTemperatureAndThermoregulationGuide />;
      case 'blog':
